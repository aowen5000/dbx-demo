...
spark = SparkSession.builder.appName("dbx-demo-cicd_task1").getOrCreate()
...
spark.sql('DROP TABLE IF EXISTS demo_dbx_table')
temps.write.mode("overwrite").saveAsTable('demo_dbx_table')
